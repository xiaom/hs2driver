...
void TCLIServiceClient::Compile(TCompileResp& _return, const TCompileReq& req)
{
  send_Compile(req);
  recv_Compile(_return);
}

void TCLIServiceClient::send_Compile(const TCompileReq& req)
{
  int32_t cseqid = 0;
...
void TCLIServiceClient::recv_Compile(TCompileResp& _return)
{
